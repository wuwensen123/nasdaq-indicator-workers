...
export class Analyzer {
  ...
  _score(ind, td, g, cfg) {
    ...
    const globalIndicators = {
      ...
      'pe_qqq': () => { const v = td.pe_ratio; const s = normPE(v, cfg.pe_normal || 25); return { ...s, value: v }; },
      'pe_sp500': () => { const v = td.pe_ratio; const s = normPE(v, cfg.pe_normal || 22); return { ...s, value: v }; },
